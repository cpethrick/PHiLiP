...
/// Exact Solution Function: Spacetime cartesian
/// For 1D+1 or 2D+1
...
public:
    /// Constructor for ExactSolutionFunction_IsentropicVortex
    /** Calls the Function(const unsigned int n_components) constructor in deal.II*/
    explicit ExactSolutionFunction_SpacetimeCartesian();
...
/// Solution for spacetime Euler by Friedrich et al 2019 eq'n 4.4
template <int dim, int nspecies, int nstate, typename real>
class ExactSolutionFunction_MoLEuler
        : public ExactSolutionFunction<dim,nspecies,nstate,real>
{
protected:
    using dealii::Function<dim,real>::value; ///< dealii::Function we are templating on
...
public:
    /// Constructor for ExactSolutionFunction_IsentropicVortex
    /** Calls the Function(const unsigned int n_components) constructor in deal.II*/
    explicit ExactSolutionFunction_MoLEuler (double time_compare);
