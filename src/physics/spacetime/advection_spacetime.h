...
class AdvectionSpacetime : public ConvectionDiffusion<dim, nspecies, nstate, real>
{
protected:
...
public:
    ...
    AdvectionSpacetime (
        ...
        std::shared_ptr< ManufacturedSolutionFunction<dim,nstate,real> > manufactured_solution_function = nullptr,
        const Parameters::AllParameters::TestType                 parameters_test = Parameters::AllParameters::TestType::run_control,
        const bool                                                has_nonzero_physical_source = false) : 
            ConvectionDiffusion<dim,nspecies,nstate,real>(parameters_input, convection, diffusion,input_diffusion_tensor,input_advection_vector,input_diffusion_coefficient,manufactured_solution_function,parameters_test,has_nonzero_physical_source)
    {};
