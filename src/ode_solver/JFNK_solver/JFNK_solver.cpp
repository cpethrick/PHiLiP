        ...
        double a_dot)
{
    ...
    jacobian_vector_product.a = a;
    jacobian_vector_product.a_dot = a_dot;
    jacobian_vector_product.two_derivative_flag = true;
    ...
    if (Newton_iter_counter == max_Newton_iter){
        std::cout << "Maximum number of Newton iterations reached. Continuing..." << std::endl; //later: change to pcout
        //std::cout << "Maximum number of Newton iterations reached. Aborting..." << std::endl; //later: change to pcout
        //std::abort();
    }
