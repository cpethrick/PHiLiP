...
{ 
    ...
    Jv.reinit_for_next_timestep(dt, epsilon_jacobian, previous_step_solution_input);
    previous_step_solution = previous_step_solution_input;
    current_solution_estimate = previous_step_solution_input;
    solution_update_newton.reinit(previous_step_solution_input);
