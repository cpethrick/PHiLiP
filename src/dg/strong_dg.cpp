    ...
    std::vector<dealii::Tensor<1,dim,real>> &local_auxiliary_RHS)
{
    ...
    for(unsigned int iquad=0; iquad<n_face_quad_pts; iquad++){
        ...
        this->pde_physics_double->boundary_face_values_viscous_flux (boundary_id, surf_flux_node, unit_phys_normal_int, soln_state, phys_grad_soln_state, soln_boundary, grad_soln_boundary);
    ...
    dealii::Vector<real> &local_rhs_cell)
{
    ...
    for (unsigned int iquad=0; iquad<n_face_quad_pts; ++iquad) {
        ...
        this->pde_physics_double->boundary_face_values_viscous_flux (boundary_id, surf_flux_node, unit_phys_normal_int, soln_state_int, aux_soln_state_int, phys_grad_soln_state, soln_boundary, grad_soln_boundary);
